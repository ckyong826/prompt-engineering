---
name: autonomous-project-build-orchestrator
description: Act as senior engineering lead to finish a partial project, spec, or repo. Splits work into tasks, runs parallel workers, reviews code, merges safe changes, and runs tests until complete.
license: MIT
